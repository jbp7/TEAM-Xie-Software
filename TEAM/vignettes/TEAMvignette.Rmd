...
author: "John Pura, Xuechan Li, Cliburn Chan, Jichun Xie"
data: "`r Sys.Date()`"
output: 
...
Below we demonstrate two examples of using TEAM on an example dataset. The data can be downloaded directly from Gitlab and loaded by calling:
