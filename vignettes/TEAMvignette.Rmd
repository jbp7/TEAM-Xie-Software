...
If the package TEAM is not installed, install it via the source file:
...
<p align="justify">
TEAM requires three inputs: a partition on the sample space, the maximum number of layers, $L$, for the aggregation tree, and the desired FDR level, $\alpha$. See the examples below for details on creating the partition.
 </p>
